...
@section('css')
    ...
    <style>
        ...
        .promo_code_banner .promo_code_balance{
            border-top-left-radius: 8px;
            border-top-right-radius: 8px;
            border-bottom-left-radius: 0px;
        }
        .promo_code_banner .promo_code_intro{
...
@endsection
@section('content')
    @include('h5.components.topbar', ['back' => route('member'), 'title' => '我的邀请码'])
            ...
            <div class="row">
                <div class="col-12">
                    <div class="promo_code_banner">
                        <div class="promo_code_balance w-100">
                        ...
                        <div class="promo_code_intro w-100">
                    ...
                    <div class="invite-user-box">
                        @forelse($inviteUsers as $item)
                            <div class="invite-user-item">
                                <span class="invite-user-item-nickname">******{{substr($item['email'], 6)}}</span> {{-- mobile --}}
