...
Route::post('/register', 'Frontend\RegisterController@passwordRegisterHandler')->middleware(['throttle:10,1']);
// 激活邮箱
Route::get('/activity/{token}','Frontend\RegisterController@activity')->name('user.activity');
// 登出
